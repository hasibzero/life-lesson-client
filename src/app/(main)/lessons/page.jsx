                  ...
                  <div className="px-5 py-3 flex-grow flex flex-col justify-between">
                    ...
                    <div className="mt-auto flex items-center gap-3">
                      {lesson?.creatorAvatar ? (
                        ...
                        <div className="w-9 h-9 rounded-full bg-[#0f766e] text-white flex items-center justify-center font-bold text-sm shrink-0 border border-zinc-200 dark:border-zinc-700">
